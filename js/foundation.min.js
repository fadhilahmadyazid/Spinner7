...
(function () {
    ...
    (e.Foundation = {
      ...
      lib_methods: {
        ...
        remove_data: function (e) {
          e
            ? (delete Foundation.cache[e.attr("data-" + this.name + "-id")],
              e.attr("data-" + this.name + "-id", ""))
        ...
        data_options: function (e) {
          ...
          var t = {},
            n,
            r,
            i = (e.attr("data-options") || ":").split(";"),
            s = i.length;
          for (n = s - 1; n >= 0; n--)
            (r = i[n].split(":")),
              /true/i.test(r[1]) && (r[1] = !0),
              /false/i.test(r[1]) && (r[1] = !1),
              r.length === 2 && (t[o(r[0])] = o(r[1]));
          return t;
        },
        delay: function (e, t) {
        ...
        scrollTo: function (t, n, r) {
          ...
          this.scrollToTimerCache = setTimeout(
            function () {
              isNaN(parseInt(s, 10)) ||
                (e.scrollTo(0, $(e).scrollTop() + s),
                this.scrollTo(t, n, r - 10));
            }.bind(this),
            10
          );
        },
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.dropdown = {
      ...
      toggle: function (t, n) {
        ...
        e("[data-dropdown-content]").not(r).css("left", "-99999px"),
          r.hasClass(this.settings.activeClass)
            ? r.css("left", "-99999px").removeClass(this.settings.activeClass)
            : this.css(r.addClass(this.settings.activeClass), t);
      },
      resize: function () {
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.clearing = {
      ...
      settings: {
        templates: {
          viewing:
            '<a href="#" class="clearing-close">&times;</a><div class="visible-img" style="display: none"><img src="//:0"><p class="clearing-caption"></p><a href="#" class="clearing-main-left"><span></span></a><a href="#" class="clearing-main-right"><span></span></a></div>',
        },
          ...
          typeof n != "string"
            ? (e(this.scope)
                ...
                .each(function () {
                  ...
                  i ||
                    ((r.$parent = n.parent()),
                    t.set_data(n, e.extend(!0, t.settings, r)),
                    t.assemble(n.find("li")),
                    t.settings.init || t.events().swipe_events());
                }),
              this.settings.init)
            : this[n].call(this, r)
        );
      ...
      update_paddles: function (e) {
        ...
        e.next().length
          ? t.find(".clearing-main-right").removeClass("disabled")
          : t.find(".clearing-main-right").addClass("disabled"),
          e.prev().length
            ? t.find(".clearing-main-left").removeClass("disabled")
            : t.find(".clearing-main-left").addClass("disabled");
      },
      center: function (e) {
        return (
          e.css({
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.forms = {
      name: "forms",
      version: "4.0.4",
      settings: { disable_class: "no-custom" },
      init: function (t, n, r) {
        return (
          (this.scope = t || this.scope),
          typeof n == "object" && e.extend(!0, this.settings, n),
            ...
            r.length !== 0 &&
              (r.attr("type") === "checkbox"
                ? (n.preventDefault(),
                  ...
                  i.length == 0 && (i = e(this).next("span.custom.checkbox")),
                  i.length == 0 && (i = e(this).prev("span.custom.checkbox")),
                  t.toggle_checkbox(i))
                : r.attr("type") === "radio" &&
                  (n.preventDefault(),
                  (s = e(this).find("span.custom.radio")),
                  s.length == 0 && (s = e(this).next("span.custom.radio")),
                  s.length == 0 && (s = e(this).prev("span.custom.radio")),
                  t.toggle_radio(s)));
          })
          .on(
            "click.fndtn.forms",
            ...
            function (n) {
              var r = e(this),
                ...
                s = i.prev();
              i.hasClass("open") || e(t.scope).trigger("click"),
                n.preventDefault();
              if (!1 === s.is(":disabled"))
                return (
                  i.toggleClass("open"),
                  i.hasClass("open")
                    ? e(t.scope).on(
                        ...
                        function () {
                          i.removeClass("open"),
                            e(t.scope).off(".fndtn.forms.customdropdown");
                        }
                      )
                    : e(t.scope).on(".fndtn.forms.customdropdown"),
                  !1
                );
            }
          )
      ...
      refresh_custom_select: function (t) {
        ...
        i.find("ul").html(""),
          ...
          s.each(function (t) {
            this.selected &&
              (i.find("li").eq(t).addClass("selected"),
              i.find(".current").html(e(this).html())),
              e(this).is(":disabled") &&
                i.find("li").eq(t).addClass("disabled");
          }),
          i.removeAttr("style").find("ul").removeAttr("style"),
          i.find("li").each(function () {
            i.addClass("open"),
              n.outerWidth(e(this)) > r && (r = n.outerWidth(e(this))),
              i.removeClass("open");
          });
      },
    ...
    Foundation.libs.joyride = {
      ...
      events: function () {
        ...
        e(this.scope)
          ...
          e(t).on(
            ...
            n.throttle(function () {
              e("[data-joyride]").length > 0 &&
                n.settings.$next_tip &&
                (n.is_phone() ? n.pos_phone() : n.pos_default());
            }, 100)
          ),
          (this.settings.init = !0);
      },
      start: function () {
        ...
        this.settings.init || this.init(),
          e.extend(!0, this.settings, this.data_options(n)),
        ...
        for (var s = i - 1; s >= 0; s--)
          this.settings[r[s]] = parseInt(this.settings[r[s]], 10);
      ...
      pos_modal: function (t) {
        this.center(),
          t.hide(),
          this.settings.$next_tip.data("closed") ||
            (e(".joyride-modal-bg").length < 1 &&
              e("body").append('<div class="joyride-modal-bg">').show(),
            /pop/i.test(this.settings.tipAnimation)
              ? e(".joyride-modal-bg").show()
              : e(".joyride-modal-bg").fadeIn(
                  this.settings.tipAnimationFadeSpeed
                ));
      },
      center: function () {
      ...
      corners: function (n) {
        ...
        return [
          n.offset().top <= r.scrollTop(),
          i <= n.offset().left + this.outerWidth(n),
          s <= n.offset().top + this.outerHeight(n),
      ...
      (Foundation.libs.orbit = {
        ...
        init: function (t, n, r) {
          ...
          typeof n == "object" && e.extend(!0, i.settings, n),
            e("[data-orbit]", t).each(e.proxy(i._init, i));
        },
        ...
        _init: function (t, n) {
          ...
          s.append(r._prev_html()),
            ...
            i.append(o.first().clone().attr("data-orbit-slide", "")),
            i.prepend(o.last().clone().attr("data-orbit-slide", "")),
        ...
        _init_events: function (i) {
          ...
          e(t)
            ...
            e(n).on("click.fndtn.orbit", "[data-orbit-link]", function (t) {
              ...
              r.length === 1 &&
                (s._reset_timer(i, !0), s.goto(i, r.index(), function () {}));
            }),
            o
        ...
        _start_timer: function (e) {
          ...
          s
            .animate({ width: "100%" }, u, "linear", r)
            .data("is-original", "beans?"),
        ...
        goto: function (t, n, r) {
          ...
          n === "prev"
            ...
            a === o.length - 1 && n === "next"
              ? (t.css("marginLeft", "0%"), (a = 1))
              : a === 0 &&
                n === "prev" &&
                (t.css("marginLeft", "-" + (o.length - 1) * 100 + "%"),
                (a = o.length - 2)),
          ...
          f.length === 1 &&
            (f.children().removeClass(i.settings.bullets_active_class),
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.reveal = {
      ...
      toggle_modals: function (e, t) {
        e.length > 0 && this.hide(e, this.settings.css.close),
          t.filter(":visible").length > 0
            ? this.hide(t, this.settings.css.close)
            : this.show(t, this.settings.css.open);
      },
      toggle_bg: function (t) {
        this.settings.bg.length === 0 &&
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.section = {
      name: "section",
      version: "4.0.5",
      settings: { deep_linking: !1, one_up: !0, callback: function () {} },
      init: function (t, n, r) {
        return (
          (this.scope = t || this.scope),
        ...
        e(this.scope).on(
          ...
          function (t) {
            e.extend(
              !0,
              n.settings,
              n.data_options(e(this).closest("[data-section]"))
            ),
              n.toggle_active.call(this, t, n);
          }
        ),
          e(t)
            .on(
            ...
            .trigger("resize"),
          e("[data-section] .content").on("click.fndtn.section", function (e) {
            e.stopPropagation();
          }),
          e("*, html, body").on("click.fndtn.section", function (t) {
            e(t.target).closest(".title").length < 1 &&
              e("[data-section].vertical-nav, [data-section].horizontal-nav")
      ...
      toggle_active: function (t, n) {
        ...
        if (i.hasClass("active"))
          ...
          if (n.small(o) || n.settings.one_up)
            r
              .closest("[data-section]")
              .find("section, .section")
              .removeClass("active")
              .attr("style", ""),
              i.css("padding-top", n.outerHeight(i.find(".title")));
          e("[data-section].vertical-nav, [data-section].horizontal-nav")
            .find("section, .section")
            .removeClass("active")
            .attr("style", ""),
            n.small(o) && i.attr("style", ""),
            i.addClass("active");
        }
        n.settings.callback();
      },
      resize: function () {
        ...
        t.each(function () {
          ...
          n.small(t)
            ? r.attr("style", "")
            : r.css("padding-top", n.outerHeight(r.find(".title"))),
            n.position_titles(t),
            n.is_horizontal(t) && !n.small(t)
              ? n.position_content(t)
              : n.position_content(t, !1);
        });
      },
      ...
      set_active_from_hash: function () {
        ...
        r.each(function () {
          var t = e(this);
          e.extend(!0, i.settings, i.data_options(t)),
            n.length > 0 &&
              i.settings.deep_linking &&
              t
                .find('.content[data-slug="' + n + '"]')
      ...
      position_content: function (t, n) {
        ...
        typeof n == "boolean"
          ...
          : (t.find("section, .section").each(function () {
              var t = e(this).find(".title"),
                n = e(this).find(".content");
              n.css({ left: t.position().left - 1, top: s.outerHeight(t) - 2 });
            }),
            typeof Zepto == "function"
              ? t.height(this.outerHeight(r.first()))
              : t.height(this.outerHeight(r.first()) - 2));
      },
      small: function (t) {
        return t && this.is_accordion(t)
          ? !0
      ...
      create: function (t) {
        var n = e(
            this.settings.tipTemplate(
              this.selector(t),
              e("<div>").html(t.attr("title")).html()
            )
          ),
          r = this.inheritable_classes(t);
        n.addClass(r).appendTo("body"),
          Modernizr.touch &&
      ...
      events: function () {
        ...
        e(this.scope)
          .on("click.fndtn.topbar", ".top-bar .toggle-topbar", function (t) {
            ...
            n.settings.$topbar.data("height") || n.largestUL(),
              t.preventDefault(),
              n.breakpoint() && r.toggleClass("expanded").css("min-height", ""),
              r.hasClass("expanded") ||
                (i.css({ left: "0%" }),
                i.find(">.name").css({ left: "100%" }),
          ...
          .on("click.fndtn.topbar", ".top-bar .has-dropdown>a", function (t) {
            ...
            if (n.breakpoint()) {
              ...
              r.data("index", r.data("index") + 1),
                ...
                i.find(">.name").css({ left: 100 * r.data("index") + "%" }),
                o
                  .siblings("ul")
          ...
          e(this.scope).on(
            ...
            function (t) {
              ...
              r.data("index", r.data("index") - 1),
                i.css({ left: -(100 * r.data("index")) + "%" }),
                i.find(">.name").css({ left: 100 * r.data("index") + "%" }),
                r.data("index") === 0 && r.css("min-height", 0),
                setTimeout(function () {
                  s.removeClass("moved");
                }, 300);
            }
